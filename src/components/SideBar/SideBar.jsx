...
const SideBar = () => {
    ...
    return (
        <aside className="
      /* Мобильный вид: снизу, на всю ширину */
      fixed bottom-0 left-0 w-full h-16 bg-blue-900 border-t border-gray-200 z-50
      /* Десктопный вид: слева, узкая колонка на всю высоту */
      md:relative md:w-20 lg:w-64 md:h-screen md:border-t-0 md:border-r
